...
[**File List**](files.md) **>** [**Server**](dir_f6675a7e1cd1d6d7f6e5e9669ead62e8.md) **>** [**src**](dir_35da1b20ef5d00fba1377c2ea4ffeb70.md) **>** [**Mouvement\_system.cpp**](Server_2src_2Mouvement__system_8cpp.md)

[Go to the documentation of this file](Server_2src_2Mouvement__system_8cpp.md)
...
Vector2D MouvementSystem::move_player(Registry &registry, std::string name) {
  ...
  for (auto &player : players) {
    ...
    if (player->name->name == name) {
      ...
      if (player->input->up)
        player->transform->velocity.y = -2;
      if (player->input->down)
        player->transform->velocity.y = 2;
      if (player->input->left)
        player->transform->velocity.x = -2;
...
void MouvementSystem::system_movement(EntityVector &entities) {
  for (auto &entity : entities) {
    if (entity->transform) {
      ...
      if (entity->transform->position.x < 0) entity->transform->position.x = 0;
