...
[**File List**](files.md) **>** [**Server**](dir_f6675a7e1cd1d6d7f6e5e9669ead62e8.md) **>** [**src**](dir_35da1b20ef5d00fba1377c2ea4ffeb70.md) **>** [**server\_room.cpp**](server__room_8cpp.md)
...
void Server::process_message_contain(udp::socket &socket,
...
void Server::handle_room_creation(udp::socket &socket,
  ...
  std::string response =
      "Room created: " + room_name + " (ID: " + std::to_string(room_id) + ")";
...
void Server::handle_list_rooms(udp::socket &socket,
                               const udp::endpoint &client_endpoint) {
