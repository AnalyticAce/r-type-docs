...
[**File List**](files.md) **>** [**GameLogic**](dir_43a675281a639807a8e84134baca4472.md) **>** [**Entity.cpp**](GameLogic_2Entity_8cpp.md)

[Go to the documentation of this file](GameLogic_2Entity_8cpp.md)
...
void Registry::spawn_enemy() {
  ...
  enemy->cirshape = std::make_unique<CirShape>(25, 30, sf::Color::Red,
                                               sf::Color::Green, 1); // Rayon 25
...
void Registry::spawn_coin() {
  ...
  coin->transform =
      std::make_unique<Transform>(Vector2D(200, 200), Vector2D(0, 0));
  coin->cirshape = std::make_unique<CirShape>(10, 30, sf::Color::Black,
                                              sf::Color::Yellow, 0);
...
void Registry::spawn_player(std::string name) {
  ...
  player->transform =
      std::make_unique<Transform>(Vector2D(100, 100), Vector2D(0, 0));
  player->bbox = std::make_unique<BBox>(Vector2D(50, 50));
  player->rectshape = std::make_unique<RectShape>(50.f, 50.f, sf::Color::Red,
                                                  sf::Color::Green, 2);
